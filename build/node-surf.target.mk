...
INCS_Debug := \
	-I/Users/nickholdren/.node-gyp/0.8.2/src \
	-I/Users/nickholdren/.node-gyp/0.8.2/deps/uv/include \
	-I/Users/nickholdren/.node-gyp/0.8.2/deps/v8/include \
...
$(builddir)/node-surf.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/node-surf.node: LIBS := $(LIBS)
$(builddir)/node-surf.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/node-surf.node: TOOLSET := $(TOOLSET)
$(builddir)/node-surf.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/node-surf.node
# Add target alias
.PHONY: node-surf
node-surf: $(builddir)/node-surf.node

# Short alias for building this executable.
.PHONY: node-surf.node
node-surf.node: $(builddir)/node-surf.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/node-surf.node
